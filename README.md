...
* The [**Denisa repository**](https://github.com/leklab/denisa) contains all scripts and resources relevant to the SGCA study, including data processing, functional-score generation, confidence classification, variant annotation, and downstream analyses.
